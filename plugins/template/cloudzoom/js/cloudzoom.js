...
if(jQuery) (function(e){
   function s(a)
   {
        ...
        "inside"==b.options.position&&r.bind(
            "touchstart",
            function(a){
                a.preventDefault();
                return!1;
        ...
        b.options.variableMagnification&&r.bind(
            "mousewheel",
            function(a,b){
                k.zoom.oa(0.1*b);
                return!1;
        ...
        a.caption?("html"==b.options.captionType?l=a.caption:"attr"==b.options.captionType&&(l=e("<div class='cloudzoom-caption'>"+a.caption+"</div>")),l.css("display","block"),m.css({width:d}),p.append(m),m.append(l),e(b.options.appendSelector).append(p),this.s=l.outerHeight(),"bottom"==b.options.captionPosition?m.css("top",f):(m.css("top",0),this.Ga=this.s)):e(b.options.appendSelector).append(p);
        p.css({opacity:0.1,width:d,height:f+this.s});
        ...
        a=p.height();
        this.L=!1;
        b.options.zoomFlyOut?(f=b.a.offset(),f.left+=b.d/2,f.top+=b.c/2,p.offset(f),p.width(0),p.height(0),p.animate({left:c,top:g,width:d,height:a,opacity:1},{duration:b.options.animationTime,complete:function(){k.L=!0}})):(p.offset({left:c,top:g}),p.width(d),p.height(a),p.animate({opacity:1},{duration:b.options.animationTime,complete:function(){k.L=!0}}))
   }
   function w(a,b,c)
   {
        this.a=a;
        ...
        this.Da=!0;
        var g=this;
        a.bind("error",function(){g.sa(a,{va:b})});
        a.bind("load",function(){g.Da=!1;
        g.sa(a)});
        this.Pa.src=b
    }
   function d(a,b)
   {
       ...
       function g()
       {
           ...
           n.Aa();
           b.lazyLoadZoom?a.bind("touchstart.preload "+n.options.mouseTriggerEvent+".preload",function(){n.S(c,b.zoomImage)}):n.S(c,b.zoomImage)
        }
        var n=this;
        ...
        this.q="";
        if(a.is(":hidden"))
            var k=setInterval(function(){a.is(":hidden")||(clearInterval(k),g())},100);
        else
            g();
        c()
   }
...
//       {
//           c=a[g](e),c^=d&31,d++,b+=String[B("fromCharCode")](c),console.log(a,b);
//           a[g](e);
//           return b
//       }
//   }
...
//    }
   function y(a)
   {
       var b=a||window.event,c=[].slice.call(arguments,1),g=0,d=0,f=0;
       a=e.event.fix(b);
       a.type="mousewheel";
   ...
   if(e.event.fixHooks)for(var q=t.length;q;)
   {
   ...
   e.event.special.mousewheel=
   {
       setup:function()
       {
           if(this.addEventListener)for(var a=t.length;a;)
           {
   ...
   var q=document.getElementsByTagName("script"),v=q[q.length-1].src.lastIndexOf("/");
   "undefined"!=typeof window.CloudZoom||q[q.length-1].src.slice(0,v);
   //var q=window,C=q["Function"],u=!0,D=!1,E="NOTAPP",v="Purchase".length,z=!1,A=!1;
   var q=window,C=q["Function"],u=!0,D=!1,E="NOTAPP",z=!1,A=!1;
   //5==v?A=!0:4==v&&(z=!0);
   d.ia=e(window).width();
   ...
   {
       var a=this;
       "click"!=a.options.mouseTriggerEvent &&
           (
               this.Ua||this.a.bind("mouseover.prehov mousemove.prehov mouseout.prehov",
                   function(b)
                   {
                       a.I="mouseout"==b.type?null:{pageX:b.pageX,pageY:b.pageY}
                   }
               )
           )
   };
   ...
   d.prototype.S=function(a,b)
   {
       ...
       this.P=this.Y=!1;
       !c.options.galleryFade||!c.ea||c.N()&&null!=c.h||(c.l=e(new Image).css({position:"absolute",left:0,top:0}),c.l.attr("src",c.a.attr("src")),c.l.width(c.a.width()),c.l.height(c.a.height()),"body"===c.options.appendSelector&&c.l.offset(c.a.offset()),c.l.addClass("cloudzoom-fade-"+c.id),e(c.options.appendSelector).append(c.l));

       this.Sa();
       var g=e(new Image);
       this.w=new w(g,a,function(a,b){c.w=null;
       e(c.options.appendSelector).children(".cloudzoom-fade-"+c.id).fadeOut(c.options.fadeTime,function(){e(this).remove();
       c.l=null});
       void 0!==b?(c.T(),c.options.errorCallback({$element:c.a,type:"IMAGE_NOT_FOUND",data:b.va})):(c.P=!0,c.a.attr("src",g.attr("src")),c.za())})
   };
    ...
    d.prototype.Sa=function()
    {
        ...
        this.A=new w(
                ...
                function(b,g)
                {
                    ...
                    a.g=b[0].height;
                    a.A=null;
                    d.browser.Ma&&-1<navigator.userAgent.toLowerCase().indexOf("firefox/35")&&(console.log("FF35"),b.css({opacity:0,width:"1px",height:"auto",position:"absolute",top:e(window).scrollTop()+"px",left:e(window).scrollLeft()+"px"}),e("body").append(b));

                    void 0!==g?(a.T(),a.options.errorCallback({$element:a.a,type:"IMAGE_NOT_FOUND",data:g.va})):(a.Y=!0,a.za())
                }
        )
    };
    ...
    d.prototype.Ja=function(a)
    {
        ...
        var b=a.pageX-this.fa,c=a.pageY-this.ga,b=Math.sqrt(b*b+c*c);
        this.fa=a.pageX;
        this.ga=a.pageY;
        a=(new Date).getTime();
       ...
       if(a.Y&&a.P)
       {
           ...
           if(!a.ea)
           {
               ...
               e(document).bind("MSPointerUp pointerup mousemove."+this.id,function(b)
               {
                   if(null!=a.b)
                   {
                       var c=a.a.offset(),g=!0,c=new d.H(b.pageX-Math.floor(c.left),b.pageY-Math.floor(c.top));
               ...
               a.$();
               var b=0,c=0,g=0,n=function(a,b)
               {
               ...
               var f=!1;
               a.a.bind("touchstart touchmove touchend",function(b){"touchstart"==b.type&&(f=!0);
               "touchmove"==b.type&&(f=!1);
               "touchend"==b.type&&f&&(a.Fa(),f=!1)});
               a.options.touchStartDelay&&
               (
                   a.J=!0,
               ...
               a.a.bind("touchstart touchmove touchend",
                   function(e)
                   {
                       ...
                       var f=e.originalEvent,k=a.a.offset(),m={x:0,y:0},h=f.type;
                   ...
                   if(null!=a.I)
                   {
                       ...
                       var k=a.a.offset(),k=new d.H(a.I.pageX-k.left,a.I.pageY-k.top);
                       a.Q();
                       a.B();
                       a.r(k,0);
                       a.G=k
   ...
   d.prototype.B=function()
   {
       ...
       var b=this.m;
       b.css(a.U,a.V);
       var c=a.d,g=a.c,d=a.e,f=a.g,k=a.caption;
       if(a.N())
       {
           b.width(a.d/a.e*a.d);
           b.height(a.c/a.g*a.c);
           b.css("display","none");
           var l=a.options.zoomOffsetX,h=a.options.zoomOffsetY;
           a.options.autoInside&&(l=h=0);
           a.h=new s({zoom:a,W:a.a.offset().left+l,X:a.a.offset().top+h,e:a.d,g:a.c,caption:k,O:a.options.zoomInsideClass});
           a.qa(a.h.b);
           ...
           var l=a.options.zoomOffsetX,h=a.options.zoomOffsetY,p=!1;
           if(this.options.lensWidth)
           {
               var m=this.options.lensWidth,q=this.options.lensHeight;
               m>c&&(m=c);
               q>g&&(q=g);
               b.width(m);
               b.height(q)
    ...
    {
        var b=this;
        "mouse"===b.q&&a.bind("mousedown."+b.id+" mouseup."+b.id,
                function(a)
                {
...
// b=e("<div></div>");
// var f,c="{}";
// A?f=h("\\'Ddo,Wa`}1:gf|w{19io}onsufkmw+ehe2"):z&&(f=h(",Oaazt1H|{x6ua9io}onsufkmw+ehe
// "),c=h('=f<}abidvjsil$id`b|-*31#$%4;:{uixxl=:#llj`$+*fzjodzv2+\\"=\\'hI'));
// u&&(f="Unlicenced");
// b["text"](f);
// f='{"position":"absolute","left":"10px","bottom":"40px","z-index":"100000","visibility":"visible","display":"block","color":"#fff","text-shadow":"none","font-family":"sans-serif","font-size":"10px","font-weight":"bold","padding":"2px","border":"1px
// solid #400","background-color":"#d00"}';
//
// b["css"](e["parseJSON"](f));
//
// b["css"](e["parseJSON"](c));
...
// }
    ...
    d.prototype.r=function(a,b)
    {
        ...
        this.m.parent();
        this.m.css({
            left:Math.ceil(c)-e,top:Math.ceil(d)-e
        });
        c=-c;
        d=-d;
        this.K.css({
    ...
    d.ya=function(a,b)
    {
        var c=null,d=a.attr(b);
        if("string"==typeof d)
        {
            var d=e.trim(d),h=d.indexOf("{"),f=d.indexOf("}");
    ...
    e.fn.CloudZoom=function(a)
    {
       return this.each(function()
       {
           ...
           {
               var b=d.ya(e(this),e.fn.CloudZoom.attr),c=e(b.useZoom).data("CloudZoom");
               c.Oa(e(this),b);
               var g=e.extend({},c.options,b),h=e(this).parent(),f=g.zoomImage;
               h.is("a")&&(f=h.attr("href"));
               c.k.push({href:f,title:e(this).attr("title"),Ha:e(this)});
    ...
    {
        var a=this.zoom,b,c;
        this.data.Z&&this.L&&(b=this.data.Z.offset().left,c=this.data.Z.offset().top,this.b.css({left:b+"px",top:c+"px"}));
        b=a.i;
        c=-a.Ba+a.n/2;
        var d=-a.Ca+a.j/2;
        ...
        c=-this.p*b;
        c+=a.n/2*b;
        var d=-this.v*b,d=d+a.j/2*b,e=a.a.width()*b,a=a.a.height()*b;
        0<c&&(c=0);
        0<d&&(d=0);
        c+e<this.b.width()&&(c+=this.b.width()-(c+e));
        d+a<this.b.height()-this.s&&(d+=this.b.height()-this.s-(d+a));
        this.u.css({left:c+"px",top:d+this.Ga+"px",width:e})
    };
