<?php
class view_message extends admin_common
{
    ...
    {
        $this->set_title(_('Message du site'));
        $this->set_css(array('admin',$this->req,'jquery-ui.min',"jquery.growl",'jquery-ui-multiselect'));
        $this->set_js(array('tinymce_var','admin', 'jquery','jquery-ui.min','tinymce/tinymce.min','tinymce/jquery.tinymce.min','jquery-ui-multiselect','headerfooter',"jquery.growl",$this->req));
