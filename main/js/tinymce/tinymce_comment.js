function load_tiny_mce_comment(content_css_set,base_path,max_char_comment)
{
    ...
    default_tinymce=
    {
        ...
        max_chars: max_char_comment, // this is a default value which can get modified later
