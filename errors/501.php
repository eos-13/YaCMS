...
class view_error extends common
{
    ...
    {
        global $conf;
        $this->set_title('501  - Not Implemented ');
        $this->set_template_file(make_path('template',"httperror",'html',false));
        $this->set_main("<h1>Not Implemented </h1><br/>Fonctionnalité réclamée non supportée par le serveur<br/><br/><a href='".$conf->main_url_root."'>Retour à l'index</a>".(isset($_SERVER['HTTP_REFERER'])?"<br/><a href='".$_SERVER['HTTP_REFERER']."'>Retour à la page précédente</a>":"")."");
        echo $this->gen_page();
        exit;
    }
}
