...
class view_error extends common
{
    public function run()
    {
        ...
        $this->set_main("<h1>Method Not Allowed </h1><br/>Méthode de requête non autorisée<br/><br/><a href='".$conf->main_url_root."'>Retour à l'index</a>".(isset($_SERVER['HTTP_REFERER'])?"<br/><a href='".$_SERVER['HTTP_REFERER']."'>Retour à la page précédente</a>":"")."");
        echo $this->gen_page();
        exit;
    }
}
