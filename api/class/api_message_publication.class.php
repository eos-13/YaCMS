...
class api_message_publication extends common_soap_object
{
...
/**
    ...
    public function get_all($id,$lang=false)
    {
        ...
        if ($this->obj->get_id() > 0)
        {
            ...
            $a['group_publication_refid'] = $this->obj->get_group_publication_refid();
            return $a;
        } else {
            return false;
        }
    ...
    /**
     * @desc Create a new publication message
     * @return int $id
     */
